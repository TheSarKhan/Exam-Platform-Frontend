          ...
          <div className="main-content">
            <div className="content-header">
              ...
              <div className="tab-boxes">
                <div className="tab-box">Açıq imtahanlar</div>
                <div className="tab-box">Gizli imtahanlar</div>
                <div className="tab-box">Adminlə işlədiyim imtahanlar</div>
              </div>
            </div>
                ...
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell align="right">Paketin adı</TableCell>
                  ...
                  <TableBody>
                    {buys.map(buy => (
                      <TableRow key={buy.id} sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                        ...
                        <TableCell align="right">{buy.plan}</TableCell>
        ...
        <main className="main-layout">
          <aside className="sidebar">
            ...
            <div className="profile-info">
              ...
              <p className="profile-role">Müəllim</p>
            </div>
            <nav className="sidebar-nav">
              ...
              <a href="#" className={`nav-item ${activeTab === "abuneliklerim" ? "active" : ""}`} onClick={() => setActiveTab("abuneliklerim")}>
                <img src={task} alt="" />
                <span>Abunəliklərim</span>
              </a>
              <button disabled={true} className={`nav-item ${activeTab === "sual-bazasi" ? "active" : ""} border-0 bg-transparent `} onClick={() => setActiveTab("sual-bazasi")}>
                <div className="d-flex justify-content-between w-100">
                  <div>
                    <img src={messages} alt="" />
                    <span className="px-3 bg-transparent">Sual Bazası</span>
                  </div>
                  <div>
                    <img src={lock} alt="" />
                  </div>
          ...
          <Box sx={style}>
            <div className="text-center">
              ...
              <div className="logut-btns">
                <button onClick={handleLogout} type="button" className="yes-btn">
                  Bəli
                </button>
                <button onClick={handleCloseLogout} type="button" className="no-btn">
                  Xeyr
                </button>
              </div>
            </div>
